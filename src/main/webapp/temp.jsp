...
<head>
    ...
    <link rel="shortcut icon" href="js/asset/ico/favicon.png">

    <link href="js/asset/css/font-awesome.min.css" rel="stylesheet">
    <link href="js/asset/css/bootstrap.css" rel="stylesheet">
    <link href="js/asset/css/carousel.css" rel="stylesheet">
    <link href="js/asset/css/echartsHome.css" rel="stylesheet">
    <script src="js/example/www/js/echarts.js"></script>
...
<script src="js/asset/js/jquery.min.js"></script>
<script type="text/javascript" src="js/asset/js/echartsHome.js"></script>
